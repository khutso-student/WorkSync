    ...
    return(
        <div className="w-full h-screen bg-[url('src/assets/Signup.jpg')] bg-cover bg-center ">
            <div className="w-full h-full bg-[#030f1bd2] flex flex-col items-center gap-10">
                <div className="flex justify-between items-center mt-5 bg-[#fff] w-[90%] sm:w-[80%] py-3 px-2.5 sm:px-4 rounded-2xl">
                    <a href="#" className="text-blue-600 text-xl font-semibold md:text-3xl">WorkSync</a>
                    <div className="flex gap-2 p-2">
                        ...
                        <Link to='/signup'
                            className="border border-[#9b9a9a] py-1 px-1 md:px-3 text-sm text-black rounded-md hover:bg-blue-400 hover:text-white hover:border-blue-400  duration-300">
                            Sign Up
                        </Link>
                    </div>
                </div>
